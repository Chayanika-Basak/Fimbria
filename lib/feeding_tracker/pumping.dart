...
import 'history/pumpingHistory.dart';
import 'package:uuid/uuid.dart';

class Pump extends StatefulWidget {
  Pump({super.key, required this.uid});
  String uid;
  @override
  State<Pump> createState() => _PumpState(uid: uid);
}
            ...
            child: CupertinoButton(
              ...
              onPressed: () async {
                ...
                await _firestore
                  ...
                  'color': colorEditingController.text!,
                  'notes': notesEditingController.text!
                }).then((value) {
                  stopwatch.reset();
                  colorEditingController.clear();
              ...
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                      ...
                      builder: (context) => PumpingHistoryScreen(
                            uid: uid,
                          )),
                );
              },
